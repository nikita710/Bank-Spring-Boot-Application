package com.teachbeyond.loans.controller;

import com.teachbeyond.loans.constants.LoansConstants;
import com.teachbeyond.loans.dto.ErrorResponseDto;
import com.teachbeyond.loans.dto.LoansContactInfoDto;
import com.teachbeyond.loans.dto.LoansDto;
import com.teachbeyond.loans.dto.ResponseDto;
import com.teachbeyond.loans.service.ILoansService;
...
@Tag(name = "CRUD REST APIs for Loans in BeyondTech", description = "CRUD REST APIs in BeyondTech to CREATE, UPDATE, FETCH AND DELETE loan details")
@RestController
...
public class LoansController {
    ...
    @Operation(summary = "Create Loan REST API", description = "REST API to create new loan inside BeyondTech")
    ...
    public ResponseEntity<LoansDto> fetchLoanDetails(
        ...
        logger.debug("techbeyond-corelation-id found: {}", correlationId);
